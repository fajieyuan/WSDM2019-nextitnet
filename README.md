...
In general, NextItNet is able to handle millions of items with billions of interaction feedbacks, and is much faster than LSTM/GRU using the same training setttings.
