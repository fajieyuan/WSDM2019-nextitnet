...
1 )you can run nextitnet_topk.py (python nextitnet_topk.py or nextitnet.py (slower at the evaluation stage because we output full softmax)) directly, which includes training and testing
